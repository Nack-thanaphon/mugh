<nav class="navbar bg-secondary navbar-expand-xl navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand d-flex justify-content-between " href="./">
            ...
            <img width="50px" height="50px" class="m-auto d-block" src="./img/logo.png" alt="">
            <div class="navbar-detail text-white pl-3  my-auto">
                <b class="p-0 m-0" style="font-size: 1.7rem;">MUGH</b>
